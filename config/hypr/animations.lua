...
hl.animation({ leaf = "windows", enabled = false, speed = 2.79, bezier = "easeInOutCubic" })
hl.animation({ leaf = "windowsIn", enabled = false, speed = 1, bezier = "easeInOutCubic", style = "popin 80%" })
hl.animation({ leaf = "windowsOut", enabled = false, speed = 1.49, bezier = "easeInOutCubic" })
